...
const Page = () => {
  ...
  return (
    <section className="w-full min-h-screen flex flex-col items-center justify-center">
      ...
      <form onSubmit={handleLogin} className="shadow-sm p-6 rounded-xl bg-white box space-y-4 w-full max-w-sm mt-6">
       <div>
       ...
       <div className="flex flex-col space-y-2">
          ...
          <Input id="email" type="email" placeholder="seuemail@kroton.com.br" />
        </div>
